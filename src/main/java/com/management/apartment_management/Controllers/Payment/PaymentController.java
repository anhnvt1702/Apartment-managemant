...
public class PaymentController implements Initializable {
    ...
    private Node createNotYetTableView(int pageIndex) {
        ...
        delete1.setCellFactory(param -> new TableCell<Contract, ImageView>() {
            private final ImageView deleteImageView = new ImageView("D:/Apartment_Management-master/src/main/resources/com/management/apartment_management/icons/delete.png");
            {
...
//                });
        ...
        edit1.setCellFactory(param -> new TableCell<Contract, ImageView>() {
            private final ImageView viewImageView = new ImageView("D:/Apartment_Management-master/src/main/resources/com/management/apartment_management/icons/edit-text.png");
            {
