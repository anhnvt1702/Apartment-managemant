...
public class ButtonController {
    public static class DeleteButtonCell extends TableCell<Contract, Contract> {
        ...
        public DeleteButtonCell() {
            ...
            ImageView deleteImage =new ImageView(new Image("D:/Apartment_Management-master/src/main/resources/com/management/apartment_management/icons/delete.png"));
    ...
    public static class EditButtonCell extends TableCell<Contract, Contract> {
        ...
        public EditButtonCell(AnchorPane basePane) {
            ...
            ImageView deleteImage =new ImageView(new Image("D:/Apartment_Management-master/src/main/resources/com/management/apartment_management/icons/edit-text.png"));
            deleteImage.setFitWidth(15);
            deleteImage.setFitHeight(19);
